<template>
  ...
  <div class="row justify-end q-gutter-md q-pa-md full-width">
    <MonthPickerMenu
      ...
      v-model="(formState as SchoolAdminForm).overview_selectedMonths"
    />

    <SingleChoiceSelector
      :isFetching="false"
      :options="levelSelectorOptions"
      v-model="(formState as SchoolAdminForm).overview_selectedGrade"
      :fieldLabel="'Grade'"
    />
  ...
  <section class="row q-col-gutter-md">
    ...
    <div class="col-12 col-md-6">
      <FollowUpList
        ...
        v-model="(formState as SchoolAdminForm).overview_followUp"
      />
    </div>
  </section>
...
import type { SchoolAdminForm } from 'src/store/formState'

import { schoolOverviewSimpleIndicatorsData } from 'src/mock/data_schools_cards_grid_data';
import { schoolFollowUpData } from 'src/mock/data_schools_follow_up';
